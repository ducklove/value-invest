...
| 완료 | 포트폴리오 기본 정렬 상태 계약을 jsdom 테스트로 이관 | `tests/js/portfolio-store.test.mjs`, `tests/test_frontend_structure.py` 문자열 검사 1건 제거 |
...
| 2026-07-02 | `git diff --check` | 통과 |
| 2026-07-02 | `node --check` 변경 JS/MJS | 통과 |
| 2026-07-02 | `python -m py_compile` 변경 Python | 통과 |
| 2026-07-02 | `python -m ruff check` HTTP 전환 변경 Python | 통과 |
| 2026-07-02 | `python -m pytest tests/test_dart_report_review.py tests/test_wiki_ingestion.py tests/test_wiki_routes.py tests/test_notifications.py -q` | 137 passed |
| 2026-07-02 | `python -m pytest tests/test_portfolio_ai_analysis.py tests/test_portfolio_ai_with_wiki.py tests/test_portfolio_asset_insights.py tests/test_portfolio_asset_insight_sources.py tests/test_portfolio_quotes.py tests/test_portfolio_names.py tests/test_benchmark_history.py tests/test_snapshot_nav.py -q` | 99 passed |
| 2026-07-02 | `git diff --check` | 통과 |
| 2026-07-02 | `python -m pytest tests/test_dependency_policy.py -q` | 3 passed |
| 2026-07-02 | `python -m ruff check tests/test_dependency_policy.py` | 통과 |
| 2026-07-02 | `npm test` | 169 passed |
| 2026-07-02 | `python -m pytest tests/test_frontend_structure.py -q` | 54 passed |
