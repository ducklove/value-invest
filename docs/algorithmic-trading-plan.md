...
작성일: 2026-09-15 · 2026-09-16 진행 상태: **보통주·우선주 및 ETF 가격비 연구, 기간 분할·비용·유동성 진단, 신호 관찰, 사전 고정 전진 평가 원장 구현. 전체 자동매매는 미완료**.

현재 사용할 수 있는 기능과 남은 조건은 [1차 구현 안내](quant-research.md)를 참고한다. 아래는 전체 목표 범위다.
